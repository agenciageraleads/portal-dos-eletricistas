...
*   [ ] **Busca Inteligente + Sinônimos:** "Cabo" = "Fio", "S8" = "S08".
*   [ ] **Banco de Especificações Técnicas:** Exibir curva, amperagem, bitola, etc.
*   [ ] **Edição de Quantidade no Orçamento:** Ajuste fácil +/- e input manual.

**Semana 2: UX Essencial & Privacidade**
*   [ ] **Campos de Observação:** Notas, prazo, pagamento no orçamento.
*   [ ] **Privacidade Toggle:** Opção de ocultar detalhes de preço (Material vs Mão de Obra).
*   [ ] **Onboarding:** Tutorial rápido para novos usuários.

**Semana 3: Ferramentas & Templates**
*   [ ] **Templates de Orçamento:** "Residencial Básico", "Chuveiro", etc.
*   [ ] **Calculadora de Cabos:** Dimensionamento básico.
*   [ ] **Sugestão de Produtos:** "Comprou cabo? Leve fita isolante".

**Semana 4: Gestão & Polimento**
*   [ ] **CRM Básico:** Status dos orçamentos (Enviado, Aprovado).

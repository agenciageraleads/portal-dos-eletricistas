...
const services = [
    ...
    { name: 'Instalação de Interruptor Simples', price: 40.00, category: 'Elétrica', sankhya_code: 9003 },
    { name: 'Instalação de Interruptor + Tomada', price: 60.00, category: 'Elétrica', sankhya_code: 9016 },
    ...
    { name: 'Instalação de Ventilador de Teto', price: 130.00, category: 'Climatização', sankhya_code: 9006 },
    ...
    { name: 'Instalação de Arandela', price: 70.00, category: 'Iluminação', sankhya_code: 9017 },
    { name: 'Instalação de Fita LED (metro)', price: 45.00, category: 'Iluminação', sankhya_code: 9018 },
    ...
    { name: 'Padrão de Entrada Trifásico', price: 1800.00, category: 'Infraestrutura', sankhya_code: 9019 },
    { name: 'Instalação de Disjuntor Unipolar', price: 40.00, category: 'Quadro de Distribuição', sankhya_code: 9011 },
    { name: 'Instalação de Disjuntor Bipolar', price: 60.00, category: 'Quadro de Distribuição', sankhya_code: 9020 },
    { name: 'Instalação de IDR (Diferencial)', price: 120.00, category: 'Quadro de Distribuição', sankhya_code: 9021 },
    { name: 'Instalação de DPS (Surto)', price: 80.00, category: 'Quadro de Distribuição', sankhya_code: 9022 },
    ...
    { name: 'Instalação de Interfone', price: 150.00, category: 'Segurança', sankhya_code: 9023 },
    { name: 'Instalação de Câmera Wi-Fi', price: 120.00, category: 'Segurança', sankhya_code: 9024 },
    { name: 'Instalação de Motor de Portão', price: 350.00, category: 'Segurança', sankhya_code: 9025 },
    { name: 'Visita Técnica / Orçamento', price: 80.00, category: 'Serviços Gerais', sankhya_code: 9026 },
];

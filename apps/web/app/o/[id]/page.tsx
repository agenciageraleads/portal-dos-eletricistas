        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <header className="bg-white shadow-sm border-b border-gray-100">
                <div className="max-w-3xl mx-auto px-4 py-6 text-center">
                    <div className="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center text-white mx-auto mb-3 shadow-blue-200 shadow-lg">
                        <PackageOpen size={24} />
                    </div>
                    <h1 className="text-xl font-bold text-gray-800">Orçamento de Materiais + Serviço</h1>
                    <p className="text-gray-500 text-sm mt-1">Preparado por <strong>{electrician?.name || 'Eletricista'}</strong> para <strong>{budget.client_name}</strong></p>
                </div>
            </header>
